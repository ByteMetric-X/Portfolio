...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    links: [
      {
        label: 'GitHub',
        href: 'https://github.com/ByteMetric-X',
      },
    ],
  },
]
...
export function Projects() {
  ...
  return (
    <section
      id="work"
      className="scroll-mt-20 border-b border-line px-6 pt-10 pb-14 md:px-12 md:pt-14 md:pb-20"
    >
      <Reveal>
              ...
              <div className="border-b border-line">
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <div className="grid grid-cols-1 items-start gap-8 pb-6 md:grid-cols-[1fr_1fr]">
